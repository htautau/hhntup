...
for i in xrange(args.nsplit):
    for dataset in datasets:
        ...
        CMD = ("%s && ./run --output-path /cluster/data05/michel/Ntuples/lephad/2012 "
        ...
        cluster.qsub(
            ...
            stderr_path='/cluster/data05/michel/Ntuples/lephad/2012',
            stdout_path='/cluster/data05/michel/Ntuples/lephad/2012',
            queue=args.queue,
            dry_run=args.dry)
