...
for i in xrange(args.nsplit):
    for dataset in datasets:
        ...
        CMD = ("%s && ./run --output-path /cluster/data05/michel/Ntuples/lephad/2012-p1443-3 "
        ...
        cluster.qsub(
            ...
            stderr_path='/cluster/data05/michel/Ntuples/lephad/2012-p1443-3',
            stdout_path='/cluster/data05/michel/Ntuples/lephad/2012-p1443-3',
            queue=args.queue,
            dry_run=args.dry)
