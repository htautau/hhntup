...
f = open("../../PowHegPythia_VBFH130_tautauhh.root")
...
t.Draw("jet1_fourvect.Eta()","jet1_fourvect.Pt() > 20000",hist=h3)
t.Draw("jet2_fourvect.Eta()","jet2_fourvect.Pt() > 20000",hist=h4)

t.Draw("jet1_fourvect.Eta()","jet1_fourvect.Pt() > 20000 && jet1_matched",hist=h9)
t.Draw("jet2_fourvect.Eta()","jet2_fourvect.Pt() > 20000 && jet2_matched",hist=h10)
...
t.Draw("jet1_fourvect_boosted.Eta()","jet1_fourvect.Pt() > 20000",hist=h7)
t.Draw("jet2_fourvect_boosted.Eta()","jet2_fourvect.Pt() > 20000",hist=h8)
...
h9.SetFillColor('red')
h9.SetFillStyle('-')
h10.SetFillColor('blue')
h10.SetFillStyle('|')

draw([h1, h2, h9, h10], axislabels=['#eta matched', 'Events'])

c.SaveAs("jet_parton_eta_matched.png")
...
t.Draw("tau1_fourvect.Eta()",hist=h2)
t.Draw("tau2_fourvect.Eta()",hist=h2)

t.Draw("tau1_fourvect.Eta()", 'tau1_matched', hist=h5)
t.Draw("tau2_fourvect.Eta()", 'tau2_matched', hist=h5)

t.Draw("trueTau1_fourvect_vis.Eta()","trueTau1_fourvect_vis.Pt()>20000",hist=h1)
t.Draw("trueTau2_fourvect_vis.Eta()","trueTau2_fourvect_vis.Pt()>20000",hist=h1)

t.Draw("tau1_fourvect_boosted.Eta()",hist=h4)
t.Draw("tau2_fourvect_boosted.Eta()",hist=h4)

t.Draw("trueTau1_fourvect_vis_boosted.Eta()","trueTau1_fourvect_vis.Pt()>20000",hist=h3)
t.Draw("trueTau2_fourvect_vis_boosted.Eta()","trueTau2_fourvect_vis.Pt()>20000",hist=h3)
...
draw([h1, h5], axislabels=['#eta matched', 'Events'])

c.SaveAs("tau_eta_matched.png")
...
jet_mass = Hist(100, 0, 600, title='true diquark mass', format='hist', fillstyle='/', legendstyle='F')
...
t.Draw("true_Mvis_tau1_tau2/1000", '(trueTau1_fourvect_vis.Pt()>20000) && (trueTau2_fourvect_vis.Pt()>20000)',hist=tau_mass)
t.Draw("true_M_quark1_quark2/1000", '(parton1_fourvect.Pt() > 20000) && (parton2_fourvect.Pt() > 20000)',hist=jet_mass)
