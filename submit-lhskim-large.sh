...
##################################################
grid-submit --yall -s LHSkim.py -u group.phys-higgs --suffix large --official --destSE=CA-MCGILL-CLUMEQ-T2_PHYS-HIGGS,UNI-FREIBURG_PHYS-HIGGS -v 7 -m datasets.cfg mc12_p1130_lephad

grid-submit --yall -s LHSkim.py -u group.phys-higgs --suffix large --official --destSE=CA-MCGILL-CLUMEQ-T2_PHYS-HIGGS,UNI-FREIBURG_PHYS-HIGGS -v 7 -m datasets.cfg embedded_p1130_lephad

grid-submit --yall -s LHSkim.py -u group.phys-higgs --suffix large --official --destSE=CA-MCGILL-CLUMEQ-T2_PHYS-HIGGS,UNI-FREIBURG_PHYS-HIGGS -v 7 -m datasets.cfg data12_p1130_muhad
grid-submit --yall -s LHSkim.py -u group.phys-higgs --suffix large --official --destSE=CA-MCGILL-CLUMEQ-T2_PHYS-HIGGS,UNI-FREIBURG_PHYS-HIGGS -v 7 -m datasets.cfg data12_p1130_ehad
grid-submit --yall -s LHSkim.py -u group.phys-higgs --suffix large --official --destSE=CA-MCGILL-CLUMEQ-T2_PHYS-HIGGS,UNI-FREIBURG_PHYS-HIGGS -v 7 -m datasets.cfg data12_p1130_leptau
