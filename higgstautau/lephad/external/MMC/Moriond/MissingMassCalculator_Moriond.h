...
*/
#ifndef MissingMassCalculatorMoriond_h
#define MissingMassCalculatorMoriond_h
...
protected:
  ...
  int TailCleanUp(int type1, TLorentzVector vis1, TLorentzVector nu1, 
		  int type2, TLorentzVector vis2, TLorentzVector nu2, 
		  double mmc_mass, double vis_mass, double eff_mass);

  double TauProbability(int type1, TLorentzVector vis1, TLorentzVector nu1, 
			int type2, TLorentzVector vis2, TLorentzVector nu2);
...
public:
  MissingMassCalculator(std::string JERProviderMMCMoriondFile="JERProviderPlots.root");
  ~MissingMassCalculator();
