...
grid-batch --dataset data --metadata datasets.cfg --student HTauProcessor ../../testdata/data
#grid-batch --dataset VBFH130hh --metadata SM_datasets.yml --student HTauProcessor ../../testdata/VBFH130_tautauhh
grid-batch --dataset VBFH100hh --metadata datasets.cfg --student HTauProcessor ../../testdata/Ztautau
