...
grid-batch --dataset data --metadata datasets.yml --student HTauProcessor --events 1000 ../../testdata/rel17

grid-batch --dataset data --metadata datasets.yml --student HTauProcessor --events 1000 ../../testdata/data
